...
You can find all the workshop content in the Git repo https://github.com/0xbharath/frida-vulncon-workshop

## Following along

### Browser based labs

Easiest way to follow along the workshop is to use the labs at https://killercoda.com/0xbharath/scenario/Frida-Workshop-Vulncon

### Manual setup using Docker

1. Clone the workshop repo `https://github.com/0xbharath/frida-vulncon-workshop`
