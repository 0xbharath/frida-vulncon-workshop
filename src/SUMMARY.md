...
- [Frida Java APIs](./android/frida_java_apis.md)
- [Java APIs](./android/java_apis.md)
- [Process Enumerate Modules](./android/process_load_modules.md)
- [Modules Enumerate Exports](./android/module_enum_exports.md)
- [Enumerate Loaded Classes](./android/java_enum_loaded_classes.md)
